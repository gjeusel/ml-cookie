...
from {{ cookiecutter.project_slug }}.constants import MODEL_DIR, RESULT_DIR
from {{ cookiecutter.project_slug }}.datahandler import DataHandleCookie
from {{ cookiecutter.project_slug }}.tuning import HyperParamsTuning
